...
#from hashtable import LinkedPair
#import sys
# sys.path.append('./hastable')
...
class DoublyLinkedList:
    ...
    def print_all(self):
        curr_node = self.head
        my = curr_node.value
        while my is not None and curr_node.next is not None:

            curr_node = curr_node.next
            print("curr_node_value", curr_node.key, curr_node.value)
...
linked_list.add_to_head(1, "bird")
linked_list.add_to_head(2, "apple")
linked_list.add_to_head(3, "dog")
linked_list.add_to_head(5, "cat")
...
print(linked_list.contains(3))
print(linked_list.contains(77))
